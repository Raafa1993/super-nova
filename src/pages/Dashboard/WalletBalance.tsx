                ...
                <Card className="card-h-100">
                    <CardBody>
                        <div className="d-flex flex-wrap align-items-center mb-4">
                            <h5 className="card-title me-2">Balanço da Carteira</h5>
                            ...
                            <div className="col-sm align-self-center">
                                <div className="mt-4 mt-sm-0">
                                    <div>
                                        ...
                                        <h6>0.4412 BTC = <span className="text-muted font-size-14 fw-normal">R$ 4025,32</span></h6>
                                    </div>

                                    <div className="mt-4 pt-2">
                                        <p className="mb-2"><i className="mdi mdi-circle align-middle font-size-10 me-2 text-primary"></i> Ethereum</p>
                                        <h6>4.5701 ETH = <span className="text-muted font-size-14 fw-normal">R$ 1123,64</span></h6>
                                    </div>

                                    <div className="mt-4 pt-2">
                                        <p className="mb-2"><i className="mdi mdi-circle align-middle font-size-10 me-2 text-info"></i> Litecoin</p>
                                        <h6>35.3811 LTC = <span className="text-muted font-size-14 fw-normal">R$ 2263,09</span></h6>
                                    </div>
                                </div>
                            </div>
                        </Row>
